      ...
      <div className="w-full max-w-md bg-surface border border-subtle rounded-2xl p-8 sm:p-10 shadow-sm">
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          <button
            ...
            className="flex items-center justify-center space-x-2 bg-surface hover:bg-canvas border border-subtle hover:border-interactive rounded-xl py-2.5 px-3 text-xs font-medium text-heading transition-all cursor-pointer"
          >
